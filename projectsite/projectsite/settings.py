...
SECRET_KEY = 'django-insecure-clrg&j#=pvwidd&*sjm6shgn#&i5odmbj3wt4+itjh9^$mtyk('

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['127.0.0.1', 'localhost', 'paaleee.pythonanywhere.com']
...
PWA_APP_DESCRIPTION = "A Progressive Web App for Student Organizations - PSUSphere"
PWA_APP_THEME_COLOR = '#1b5e20'
PWA_APP_BACKGROUND_COLOR = '#e8f5e9'
